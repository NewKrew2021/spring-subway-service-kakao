...
public class FareUtil {
    ...
    public static final int AMOUNT_PER_MONEY_BETWEEN_10KM_TO_50KM = 100;
    ...
    public static final int AMOUNT_PER_MONEY_OVER_50KM = 100;
    ...
    public static int getExtraFareByDistance(int distance) {
        if(distance < DISTANCE_50KM) {
            return (int) Math.ceil((double)(distance - DISTANCE_10KM) / DIVISOR_BETWEEN_10KM_TO_50KM) * AMOUNT_PER_MONEY_BETWEEN_10KM_TO_50KM;
        }
        return EXCESS_50KM_MONEY + Math.max(0, (int) Math.ceil((double)(distance - DISTANCE_50KM) / DIVISOR_OVER_50KM) * AMOUNT_PER_MONEY_OVER_50KM);
    }
}

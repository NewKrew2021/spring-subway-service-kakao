...
class ShortestGraphTest {
    ...
    public void Test1() {
        ...
        //then
        assertThat(shortestGraph1.getGraphPath().getWeight()).isEqualTo(40);
        assertThat(shortestGraph1.getGraphPath().getVertexList()).isEqualTo(expectedStations1);

        assertThat(shortestGraph2.getGraphPath().getWeight()).isEqualTo(60);
        assertThat(shortestGraph2.getGraphPath().getVertexList()).isEqualTo(expectedStations2);

        assertThat(shortestGraph3.getGraphPath().getWeight()).isEqualTo(50);
